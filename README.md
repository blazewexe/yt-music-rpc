...
<p align="center">
  <img src="https://img.shields.io/badge/Version-1.3.2-blue?style=for-the-badge" alt="Version 1.3.2" />
...
Push a version tag that matches `manifest.json` (for example, `v1.3.2`) to run the
